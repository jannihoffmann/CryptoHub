...
#[derive(Debug)]
pub struct CryptoHubXProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoHubXProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoHubX processing");
    
    let mut processor = CryptoHubXProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoHubXProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoHubXProcessor::new(false);
